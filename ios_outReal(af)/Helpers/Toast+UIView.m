...
- (void)HYShowToast:(NSString *)message duration:(CGFloat)interval {
    [self showToast:[ToastLabel toastWithString:message] duration:interval position:kPosition];
}
- (void)HYShowToast:(NSString *)message duration:(CGFloat)interval position:(id)position {
    [self showToast:[ToastLabel toastWithString:message] duration:interval position:[NSValue valueWithCGPoint:CGPointMake(DeviceWidth/2, DeviceHeight/2)]];
}
@end
