...
SVProgressHUDMaskType defaultHudMaskType = SVProgressHUDMaskTypeBlack;
...
+ (void)show {
    [[SVProgressHUD sharedView] showWithStatus:nil maskType:defaultHudMaskType networkIndicator:NO];
}

+ (void)showWithStatus:(NSString *)status {
    [[SVProgressHUD sharedView] showWithStatus:status maskType:defaultHudMaskType networkIndicator:NO];
}
...
+ (void)showSuccessWithStatus:(NSString *)string {
    [SVProgressHUD showSuccessWithStatus:string duration:DEFAULT_DELAY];
}
...
+ (void)showErrorWithStatus:(NSString *)string {
    [SVProgressHUD showErrorWithStatus:string duration:DEFAULT_DELAY];
}
